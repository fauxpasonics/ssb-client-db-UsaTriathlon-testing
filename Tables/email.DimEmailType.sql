...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__0A0A2FAC] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__0AFE53E5] DEFAULT (getdate()),
