...
[DimEmailID] [int] NULL,
[CreatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Creat__0DDAC090] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Updat__0ECEE4C9] DEFAULT (getdate()),
