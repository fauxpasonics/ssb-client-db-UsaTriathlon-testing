...
GO
CREATE CLUSTERED INDEX [IX_RecognitionAuditFailure_DimCustomerID_CreateDate] ON [mdm].[RecognitionAuditFailure] ([DimCustomerID], [CreateDate]) WITH (DATA_COMPRESSION = PAGE)
GO
