...
GO
CREATE NONCLUSTERED INDEX [CDIO_Input_Custom2] ON [dbo].[CleanDataOutput] ([Input_Custom2]) INCLUDE ([EmailAddress], [FirstName], [LastName], [MiddleName], [Suffix]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [CDIO_Custom2_Phone] ON [dbo].[CleanDataOutput] ([Input_Custom2]) INCLUDE ([FirstName], [LastName], [MiddleName], [Phone], [Suffix]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [BUSINESS_CONTACT] ON [dbo].[CleanDataOutput] ([Input_Custom2], [Input_Custom5]) INCLUDE ([Address], [Address2], [City], [Plus4], [State], [Suite], [ZipCode]) WITH (DATA_COMPRESSION = PAGE)
GO
