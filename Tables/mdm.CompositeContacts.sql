...
GO
ALTER TABLE [mdm].[CompositeContacts] ADD CONSTRAINT [PK_CompositeContacts_cc_id] PRIMARY KEY NONCLUSTERED  ([cc_id])
GO
...
GO
CREATE CLUSTERED INDEX [IX_CompositeContacts] ON [mdm].[CompositeContacts] ([SSB_CRMSYSTEM_CONTACT_ID]) WITH (DATA_COMPRESSION = PAGE)
GO
