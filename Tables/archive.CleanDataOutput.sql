...
GO
CREATE NONCLUSTERED INDEX [IX_CleanDataOutput_Custom2] ON [archive].[CleanDataOutput] ([Input_Custom2]) INCLUDE ([ETL_CreatedDate], [Input_SourceSystem], [SourceContactId]) WITH (DATA_COMPRESSION = PAGE)
GO
